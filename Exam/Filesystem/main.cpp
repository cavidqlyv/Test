...
public:
	...
	virtual void printSort(std::string) = 0;
	virtual void printInfo(std::string) = 0;
	virtual int getDirCount(std::string) = 0;
	virtual void createFile(std::string) = 0;
	virtual void move(std::string, std::string) = 0;
	virtual void copy(std::string, std::string) = 0;
	virtual std::string getDir(std::string, int) = 0;
	virtual void rename(std::string, std::string) = 0;
	virtual void printDirectory(std::string, int) = 0;
	virtual void printRecursiveDirectory(std::string) = 0;
	virtual void createFolder(std::string, std::string) = 0;
	virtual std::string getFileName(std::string, std::string) = 0;
};
...
public:
	...
	Filesystem()
	{
		base = "C:\\Users\\salehzade89\\Desktop\\";
		current = base + "New folder";
	}
