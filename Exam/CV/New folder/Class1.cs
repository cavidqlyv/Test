    ...
    public class Worker : User
    {
        ...
        public void ShowCV()
        {
            ...
            if (CV != null)
            {
                ...
                if (CV.Experience == Experience.Year1)
                    Console.WriteLine($"Experience : Under 1 Year");
                else if (CV.Experience == Experience.Year13)
                    Console.WriteLine("Experience : 1-3 Year");
                else if (CV.Experience == Experience.Year35)
                    Console.WriteLine("Experience : 3-5 Year");
                else if (CV.Experience == Experience.Year5)
        ...
        public void ViewAppeals()
        {
            foreach (var item in list)
            {
                ...
                foreach (var item1 in item.Appeals)
                {
                    ...
                    Console.WriteLine("Education : " + item1.Education);
                    if (item1.Experience == Experience.Year1)
                        Console.WriteLine($"Experience : Under 1 Year");
                    else if (item1.Experience == Experience.Year13)
                        Console.WriteLine("Experience : 1-3 Year");
                    else if (item1.Experience == Experience.Year35)
                        Console.WriteLine("Experience : 3-5 Year");
                    else if (item1.Experience == Experience.Year5)
                        Console.WriteLine("Experience : More 5 Year");
                    Console.WriteLine("\n-----------------\n");
                }
            }
    ...
    static class GetData
    {
        ...
        public static Experience GetExperience()
        {
            while (true)
            {
                ...
                int.TryParse(Console.ReadLine(), out int key);
                if (key == 1)
                    return Experience.Year1;
                else if (key == 2)
                    return Experience.Year13;
                else if (key == 3)
                    return Experience.Year35;
                else if (key == 4)
                    return Experience.Year5;
                else
                    Console.WriteLine("Wrong");
            }
        }
