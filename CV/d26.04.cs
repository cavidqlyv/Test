    ...
    class Worker : User
    {
        ...
        public void AddCV()
        {
            ...
            while (true)
            {
                ...
                if (key == 1)
                {
                    CV.Experience = Experience.Y1;
                    break;
                }
                else if (key == 2)
                {
                    CV.Experience = Experience.Y13;
                    break;
                }
                else if (key == 3)
                {
                    CV.Experience = Experience.Y35;
                    break;
                }
                else if (key == 4)
                {
                    CV.Experience = Experience.Y5;
                    break;
                }
                else
                    Console.WriteLine("Wrong");
            ...
            while(true)
            {
                ...
                if (key == 1)
                {
                    CV.Category = Category.Doctor;
                    break;
                }
                else if (key == 2)
                {
                    CV.Category = Category.Journalist;
                    break;
                }
                else if (key == 3)
                {
                    CV.Category = Category.ITspecialist;
                    break;
                }
                else if (key == 4)
                {
                    CV.Category = Category.Translator;
                    break;
                }
                else
                    Console.WriteLine("Wrong");
