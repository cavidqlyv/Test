...
int main()
{
	...
	Container<char> container('b');
	container.push('a', greater);
	container.push('c', greater);



	Container<int> container1(6);
	...
	Container<int> container2(6);
	Container<int> container3(6);

	Container<char> container4('b');
	Container<char> container5('b');
	Container<char> container6('b');
	...
	Container<Container<int>> container7(container1);
