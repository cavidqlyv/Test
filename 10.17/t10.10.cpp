...
void door(int d[1], int a[1], int alarm[1]) {
...
void wather(int w[1], int s[1], int a[1], int alarm[1]) {
...
void wather1(int w[1], int s[1], int a[1], int alarm[1]) {
...
void cam(int c[1], int a[1], int d[1], int s[1], int alarm[1]) {
...
void status(int a[1], int c[1], int d[1], int w[1], int s[1], int alarm[1] , int t[1]) {
...
int main() {
	...
	int a[1], c[1], d[1], w[1], s[1], b = 1 , t[1];
	int alarm[1];
	alarm[0] = 0;
	a[0] = 0;
	c[0] = 0;
