...
//                            'url' => array('/project'),
        'visible' => !Yii::app()->user->isGuest && Yii::app()->params['tabs']['Project'],
...
//                            'url' => array('/task'),
        'visible' => !Yii::app()->user->isGuest && Yii::app()->params['tabs']['Task'],
...
//                            'url' => array('/user'),
        'visible' => !Yii::app()->user->isGuest && Yii::app()->params['tabs']['User'] && $userVisible,
...
//                            'url' => array('/charge'),
        'visible' => !Yii::app()->user->isGuest && Yii::app()->params['tabs']['Charge'],
//                            'active' => Yii::app()->controller->id === 'charge',
    ...
    array(
        ...
        //   'url' => array('/authItem'),
        'visible' => !Yii::app()->user->isGuest && Yii::app()->params['tabs']['Authorization'] && Yii::app()->user->checkAccess('adminRole'),
