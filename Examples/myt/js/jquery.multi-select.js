...
!function($) {
    ...
    var MultiSelect = function(element, options) {
        ...
        this.$selectableContainer = $('<span/>', {'class': 'ms-selectable'});
        this.$selectionContainer = $('<span/>', {'class': 'ms-selection'});
    ...
    MultiSelect.prototype = {
        ...
        init: function() {
            ...
            if (ms.next('.ms-container').length === 0) {
                ...
                var imgSrc = "../images/multi-select-switch.png";
//                if (!ImageExist(imgSrc))
//                    imgSrc = "../../images/multi-select-switch.png";
                that.$container.append($.parseHTML('<img id="multi-select-switch" src="' + imgSrc + '" alt="" />'));
                var img = new Image();
                img.onload = function() {
                    $("#multi-select-switch").prop("src", imgSrc);
                };
                img.onerror = function() {
                    imgSrc = "../" + imgSrc;
                    img.src = imgSrc;
                };
                img.src = imgSrc; // fires off loading of image
