...
{
	/// <summary>
	/// Used to authorise the save of a sub project item.
	/// </summary>
	[AuthoriseStrategy("Save", "ISubProjectItem")]
	public class AuthoriseSaveSubProjectItemStrategy : AuthoriseSaveStrategy
	{
		public AuthoriseSaveSubProjectItemStrategy()
		{
		}
		...
		public override bool IsAuthorised(SoftwareMonkeys.WorkHub.Entities.IEntity entity)
		{
			...
			{
				ISubProjectItem subItem = (ISubProjectItem)entity;
				
				IProjectItem item = (IProjectItem)subItem.Parent;
				
				if (item == null)
					throw new ArgumentException("The Parent property of the provided sub project item must be set.");
