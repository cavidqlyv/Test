...
namespace SoftwareMonkeys.WorkHub.Modules.Projects.Business.Security
{
	...
	/// 
	/// </summary>
	[AuthoriseReferenceStrategy("Project", "Contributors", "User")]
	public class AuthoriseReferenceProjectContributorsStrategy : AuthoriseReferenceStrategy
	{
		public AuthoriseReferenceProjectContributorsStrategy()
		{
		}
