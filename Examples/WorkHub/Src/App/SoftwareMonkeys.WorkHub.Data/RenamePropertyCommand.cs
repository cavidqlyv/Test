...
C:\Projects\SoftwareMonkeys\SiteStarter\Src\App\SoftwareMonkeys.SiteStarter.Data\RenamePropertyCommand.cs
...
namespace SoftwareMonkeys.WorkHub.Data
{
	...
	public class RenamePropertyCommand : DataSchemaCommand
	{
		...
		{
			using (LogGroup logGroup = LogGroup.Start("Executing the rename property command on the provided entity reference (as an XML document).", LogLevel.Debug))
			{
		...
		{
			using (LogGroup logGroup = LogGroup.Start("Executing the rename property command on the provided serialized entity (as an XML document).", LogLevel.Debug))
			{
