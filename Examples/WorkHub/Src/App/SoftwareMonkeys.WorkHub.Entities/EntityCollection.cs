...
C:\Projects\SoftwareMonkeys\SiteStarter\Src\App\SoftwareMonkeys.SiteStarter.Entities\EntityCollection.cs
...
namespace SoftwareMonkeys.WorkHub.Entities
{
	...
	public class Collection<E> : List<E>, ICollection<E>, IEnumerable<E>, IEnumerable
		where E : SoftwareMonkeys.WorkHub.Entities.IEntity
	{
		public Guid[] IDs
		{
			get { return GetIDs(); }
