...
W:\Work\SoftwareMonkeys\SiteStarter\Src\App\SoftwareMonkeys.SiteStarter.Diagnostics\LogGrower.cs
...
namespace SoftwareMonkeys.WorkHub.Diagnostics
{
	...
	public class LogGrower
	{
		...
		public void CreateTree(string threadFile)
		{
			...
			if (threadDoc.DocumentElement == null)
				throw new Exception("No document element found.");
			
			if (threadDoc.DocumentElement.ChildNodes != null)
			{
