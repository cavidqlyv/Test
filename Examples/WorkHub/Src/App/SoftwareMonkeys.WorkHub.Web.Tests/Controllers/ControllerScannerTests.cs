...
C:\Projects\SoftwareMonkeys\SiteStarter\Src\App\SoftwareMonkeys.SiteStarter.Web.Tests\Controllers\ControllerScannerTests.cs
	...
	public class ControllerScannerTests : BaseWebTestFixture
	{
		...
		public void Test_FindControllers()
		{
			...
			string[] assemblyPaths = new string[] {
				Assembly.Load("SoftwareMonkeys.WorkHub.Web").Location
			};
