...
W:\Work\SoftwareMonkeys\SiteStarter\Src\App\SoftwareMonkeys.SiteStarter.Configuration.Tests\MockAppConfig.cs
...
namespace SoftwareMonkeys.WorkHub.Configuration.Tests
{
	...
	/// </summary
	[XmlType(Namespace = "urn:SoftwareMonkeys.WorkHub.Config")]
	[XmlRoot(Namespace = "urn:SoftwareMonkeys.WorkHub.Config")]
	public class MockAppConfig : BaseConfig, IAppConfig
	{
		...
		/// <summary>
		/// Gets/sets the modules that are currently enabled.
		/// </summary>
