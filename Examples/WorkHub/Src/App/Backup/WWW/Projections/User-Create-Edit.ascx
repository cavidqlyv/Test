...
C:\Projects\SoftwareMonkeys\SiteStarter\Src\App\WWW\Projections\User-Create-Edit.ascx
...
<%@ Control Language="C#" ClassName="CreateEditUserProjection" Inherits="SoftwareMonkeys.WorkHub.Web.Projections.BaseCreateEditProjection" %>
        ...
        ((EntitySelect)sender).DataSource = IndexStrategy.New<UserRole>().Index();
                   ...
                   <h1>
                            ...
                            <cc:EntityForm runat="server" DataSource='<%# DataSource %>' id="DataForm" CssClass="Panel" headingtext='<%# OperationManager.CurrentOperation == "CreateUser" ? Resources.Language.NewUserDetails : Resources.Language.UserDetails %>' headingcssclass="Heading2" width="100%">
                              ...
                              <FieldTemplate>
                                  <cc:EntitySelect width="400" EntityType="SoftwareMonkeys.WorkHub.Entities.UserRole, SoftwareMonkeys.WorkHub.Entities" runat="server"
