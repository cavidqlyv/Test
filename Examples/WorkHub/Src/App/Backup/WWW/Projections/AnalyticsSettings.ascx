<%@ Control Language="C#" ClassName="AnalyticsSettings" Inherits="SoftwareMonkeys.WorkHub.Web.Projections.BaseProjection" %>
...
<script runat="server">
    ...
    private void UpdateSettings()
    {
        ...
        config.Settings["AnalyticsCode"] = AnalyticsCode.Text;
        ...
        Result.Display(Resources.Language.AnalyticsCodeUpdated);
    ...
    <asp:MultiView ID="PageView" runat="server">
        <asp:View ID="SettingsFormView" runat="server">
                         ...
                         <h1>
                        <%# Resources.Language.AnalyticsSettings %>
                        </h1>
                          <cc:Result runat="server"></cc:Result>
                        <p>
                             <%# Resources.Language.EditAnalyticsSettingsIntro %>
                         </p>
                                               
                            <table class="BodyPanel" width="100%">
                                <tr>
                                    <td colspan="2" class="Heading2"><%# Resources.Language.AnalyticsSettings %></td>
                                </tr>
                                 <tr>
                                    <td class="FieldLabel"><%# Resources.Language.AnalyticsCode + ":"%></td>
                                    <td class="Field">
                                    <asp:TextBox runat="Server" id="AnalyticsCode" width="400px" cssClass="Form" textmode="multiline" rows="10" text='<%# Config.Application.Settings.GetString("AnalyticsCode") %>'/>
                                </tr>
                                <tr>
                                    <td></td><td>
