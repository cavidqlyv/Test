...
{
	[TestFixture]
	public class EditOwnPasswordTestFixture_iexplore : SoftwareMonkeys.WorkHub.Functional.Tests.BaseFunctionalTestFixture
	{
		...
		[Test]
		public void Test_EditOwnPassword()
		{
			...
			selenium.Type("ctl00_Body_ctl00_Username", "approveduser2");
			...
			selenium.Type("ctl00_Body_ctl00_Password", "newpass");
			selenium.Type("ctl00_Body_ctl00_PasswordConfirm", "newpass");
			selenium.Click("ctl00_Body_ctl00_UpdateButton");
			selenium.WaitForPageToLoad("30000");
			selenium.WaitForPageToLoad("30000");
			Assert.IsTrue(selenium.IsTextPresent("My Details"), "Text 'My Details' not found when it should be.");
			...
			selenium.Click("SignOutLink");
			selenium.WaitForPageToLoad("30000");
			selenium.Type("ctl00_Body_ctl00_Login_UserName", "approveduser2");
			selenium.Type("ctl00_Body_ctl00_Login_Password", "newpass");
