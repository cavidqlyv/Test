...
{
	[TestFixture]
	public class CachesTestFixture_iexplore : SoftwareMonkeys.WorkHub.Functional.Tests.BaseFunctionalTestFixture
	{
		...
		public void Test_Caches()
		{
			...
			Assert.IsTrue(selenium.IsTextPresent("SoftwareMonkeys.WorkHub.Entities.dll"), "Text 'SoftwareMonkeys.WorkHub.Entities.dll' not found when it should be.");
			...
			Assert.IsTrue(selenium.IsTextPresent("SoftwareMonkeys.WorkHub.Business.dll"), "Text 'SoftwareMonkeys.WorkHub.Business.dll' not found when it should be.");
			selenium.Click("CacheIndexLink");
			selenium.WaitForPageToLoad("30000");
			...
			Assert.IsTrue(selenium.IsTextPresent("SoftwareMonkeys.WorkHub.Web.Controllers"), "Text 'SoftwareMonkeys.WorkHub.Web.Controllers' not found when it should be.");
			Assert.IsTrue(selenium.IsTextPresent("SoftwareMonkeys.WorkHub.Web.dll"), "Text 'SoftwareMonkeys.WorkHub.Web.dll' not found when it should be.");
			selenium.Click("CacheIndexLink");
			selenium.WaitForPageToLoad("30000");
