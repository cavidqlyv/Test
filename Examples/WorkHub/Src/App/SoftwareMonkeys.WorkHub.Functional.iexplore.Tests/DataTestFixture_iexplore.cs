...
{
	[TestFixture]
	public class DataTestFixture_iexplore : SoftwareMonkeys.WorkHub.Functional.Tests.BaseFunctionalTestFixture
	{
		...
		public void Test_Data()
		{
			...
			selenium.WaitForPageToLoad("30000");
			Assert.IsFalse(selenium.IsTextPresent("Exception"), "Text 'Exception' found when it shouldn't be.");
			Assert.IsTrue(selenium.IsTextPresent("SoftwareMonkeys.WorkHub.Entities.User"), "Text 'SoftwareMonkeys.WorkHub.Entities.User' not found when it should be.");
