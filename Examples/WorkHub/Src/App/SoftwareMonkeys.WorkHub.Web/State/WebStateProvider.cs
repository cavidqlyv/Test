...
C:\Projects\SoftwareMonkeys\SiteStarter\Src\App\SoftwareMonkeys.SiteStarter.Web\State\WebStateProvider.cs
...
using SoftwareMonkeys.WorkHub.Web.State.Cookies;
using System.IO;
using System.Web;
...
{
	/// <summary>
	/// Handles web based state management.
	/// </summary>
	public class WebStateProvider : BaseStateProvider
	{
		private string physicalApplicationPath = String.Empty;
		/// <summary>
		/// Gets/sets the full physical path to the root of the application.
		/// </summary>
		public override string PhysicalApplicationPath
		{
			get {
				if (physicalApplicationPath == String.Empty && HttpContext.Current != null)
				{
		...
		/// <summary>
		/// Gets/sets the virtual path to the root of the application.
		/// </summary>
