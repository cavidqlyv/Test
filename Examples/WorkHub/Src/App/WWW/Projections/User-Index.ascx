...
C:\Projects\SoftwareMonkeys\SiteStarter\Src\App\WWW\Projections\User-Index.ascx
...
<%@ Control Language="C#" ClassName="UserIndex" Inherits="SoftwareMonkeys.WorkHub.Web.Projections.BaseIndexProjection" autoeventwireup="true" %>
