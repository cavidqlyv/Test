    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            <div class="Heading1">
                        ...
                        <p>
                            <%= Language.ActorsXmlIntro %>
                        </p>
                    <div class="Heading2"><%= Language.ActorsXmlPages %></div>
                    <ul><li><a href="<%= new ExternalUrlCreator().CreateExternalXmlUrl("Index", "Actor") %>" target="_blank"><%= Language.AllActorsInProject %></a></li>
                    </ul>