...
<script runat="server">
    ...
    <asp:MultiView runat="server" ID="PageViews">
        <asp:View runat="server" ID="DetailsView">
                     <H1><%= Language.LinkToSuggestions %></H1>
                     <cc:Result runat="Server"></cc:Result>
                     <p><%= Language.LinkToSuggestionsIntro %></p>
                     <h2>Simple Link</h2>
                     <H3>Example:</H3>
                     <p>
						<textarea class="CodeExample" style="width: 100%;" rows="1"><%= new ExternalNavigator().GetExternalLink("Post", "Suggestion") %></textarea>
						</p>
                     <H3>Code:</H3>
                     <p>
        	         <textarea class="CodeExample" style="width: 100%;" rows="3"><a href='<%=  new ExternalNavigator().GetExternalLink("Post", "Suggestion") %>'>
    Post suggestion
</a>
						</textarea>
					</p>
