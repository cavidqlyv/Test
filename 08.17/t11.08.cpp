...
void main() {
	...
	*/
	...
	case 3: cout << "Logini daxil edin\n";
		...
		break;
	case 4 : cout << "Logini daxil edin\n";
		cin >> login;
		if (login != 1234) { cout << "Logini duzgun daxil edin\n"; }
		else
		{
			cout << "Sifreni daxil edin\n";
			cin >> pas;
			...
			else
			{
				...
				cin >> oldpas;
				if (pas != 123456) { cout << "Sifreni duzgun daxil edin\n"; }
				else
				{
					cout << "Yeni sifreni daxil edin\n";
					cin >> newpas;
					if (newpas < 100000) { cout << "Sifre 6 reqemnen uzun olmalidir\n"; }
					else
					{
						cout << "sifreni tekrar daxil edin\n";
							cin >> newpas2;
						if (newpas != newpas2) { cout << "Sifreler eyni deyil\n"; }
						else { cout << "Sifre ugurla deyisdirildi\n"; }
					}
				}
			}
		}
