...
void main()
{
	...
	if (yas < 0)
	{
		cout << "yasinizi duzgun daxil edin\n";
	}
	else
	{
		if (yas <= 6)
		{
			cout << "siz usaq baxcasina gedirsiniz\n";
		}
		else if (yas > 6 && yas < 18)
		{
			cout << "siz mektebe gedirsiniz\n";
		}
		else if (yas == 18 && yas < 24)
		{
			...
			if (esgerlik == 1 || esgerlik == 2)
			{
				if (esgerlik = 1)
				{
					cout << "siz universtete gedirsiniz ve 23 yasinizda esgerliye gedeceysiniz\n";
				}
				else
				{
					cout << "siz esgerliye gedirsiniz";
				}
			}
			else
				cout << "Duzgun daxil et!";
		}
		else if (yas > 23 && yas < 61)
		{
			cout << "Sizin islemek vaxtinizdir\n";
		}
		else if (yas >= 60)
		{
			cout << "sizin pensiya vaxtinizdir\n";
		}
	}
