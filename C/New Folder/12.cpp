...
void main()
{
	...
	*/
	int login = 0, pas = 0, pas2 = 0, num = 0, pin = 0, user = 0, pas3 = 0, oldpas = 0, newpas = 0, newpas2 = 0; // pas3 - thlukesizlik sifresi
	cout << "Xos gelmisiniz\nSecimlerden Birini Secin\n1. Qeydiyyat Ucun 1 Basin\n2. Daxil olmaq ucun 2 basin\n3. Sirenin berpasi ucun 3 basin\nSifreni deyismek ucun - 4 basin\n";
	cin >> num;
	switch (num)
	...
	case 1:
		...
		else
		{
			...
			if (pas < 100000 || pas < 0)
			{
				cout << "Sifre 6 reqemnen az olmamalidir!";
			}
			else
			{
				...
				if (pas2 != pas)
				{
					cout << "Daxil etdiyiniz sifreler eyni deyil\n";
				}
				else
				{
					...
					else
					{
						...
						if (user != 1 && user != 2)
						{
							cout << "Bele istifadeci novu yoxdur\n";
						}
						else
						{
							...
							if (pas3 != 1234)
							{
								cout << "Sifreni duzgun daxil edin\n";
							}
							else
							{
								cout << "Login " << login << "\n";
			...
			else
			{
				...
				else
				{
					...
					else
					{
						...
						if (newpas != newpas2)
						{
							cout << "Sifreler eyni deyil\n";
						}
						else
						{
							cout << "Sifre ugurla deyisdirildi\n";
						}
					}
				}
			}
