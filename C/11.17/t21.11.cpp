...
void game(int *size, int difficulty)
{
	...
	int win = 0;
	if (difficulty == 1)
		difficulty1 = size[0] * size[1] / 6;
	else if (difficulty == 2)
		difficulty1 = size[0] * size[1] / 5;
	else if (difficulty == 3)
		difficulty1 = size[0] * size[1] / 4;
		...
		else if (keyarr[2] == 1)
		{
			...
			else if (key == KB_ENTER)
			{
				while (1)
				{
					...
					key = _getch();
					if (key == KB_UP && size[0] < 20)
						size[0]++;
					else if (key == KB_DOWN && size[0] > 5)
						size[0]--;
					else if (key == KB_ENTER)
						break;
				}
		...
		else if (keyarr[3] == 1)
		{
			...
			else if (key == KB_ENTER)
			{
				while (1)
				{
					...
					key = _getch();
					if (key == KB_UP && size[1] < 20)
						size[1]++;
					else if (key == KB_DOWN && size[1] > 5)
						size[1]--;
					else if (key == KB_ENTER)
						break;
				}
		...
		else if (keyarr[4] == 1)
		{
			...
			else if (key == KB_ENTER)
			{
				while (1)
				{
					...
					key = _getch();
					if (key == KB_UP && difficulty > 1)
						difficulty--;
					else if (key == KB_DOWN && difficulty < 3)
						difficulty++;
					else if (key == KB_ENTER)
						break;
				}
